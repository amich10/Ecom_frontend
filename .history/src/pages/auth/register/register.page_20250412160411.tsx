...
export const RegisterPage = () => {
  ...
  const formSubmit = async (data: any) => {
    try {
      ...
      notifyUserRegistration(
        "Your account has been created successfully. An email has been sent to your registered email to activate your accounnt.",
      ...
      notifyUserRegistration(
        "Error occured in creating in your account",
      ...
      <div className="flex justify-center h-screen items-center py-10">
        <div className="w-120 bg-white rounded-md p-4 shadow-2xl  shadow-violet-400 border-2 border-violet-700 font-serif">
          ...
          <form onSubmit={handleSubmit(formSubmit)}>
            ...
            <div className="mt-3">
              <InputLabel htmlFor="image" classes={`block`}>
                {" "}
                Profile Image
              </InputLabel>
