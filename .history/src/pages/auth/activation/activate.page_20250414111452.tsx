...
export const ActivatePage = () =>{
    ...
    const activateUser = async () =>{
        try {
            ...
            notifyUserRegistration(response.result.message, NotificationType.SUCCESS)
        } catch (exception) {
            console.log(exception)
            notifyUserRegistration("Sorry, you account cannot be acitivated. Please try again.",NotificationType.ERROR)
        } finally{
            naviagte('/')
        }
    }
