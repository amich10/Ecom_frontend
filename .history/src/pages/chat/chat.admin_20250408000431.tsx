...
const ChatPage = () => {
    return (
        ...
        <Content>
            ...
            <div className="w-1/4 h-full border-2 border-blue-400 rounded-md p-2">
                {/* Left content */}
               <div className="p-2">
               ...
               <div>
                <div className="flex gap-2 p-2 bg-blue-500">
                    <img src="https://placehold.co/50x50" alt="" className="rounded-full"/>
                    <div>
                        <h1 className="font-bold">Amich Budha Magar</h1>
                        <p className="text-sm italic">This is a text from Amich Budha Magar</p>
                    </div>
                </div>
               </div>
            </div>
