...
const BrandList = () => {
  ...
  const getAllbrands = async ({
    ...
    try {
      ...
      notifyUserRegistration(
        "brands cannot be displayed at this time. Please try again later.",
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "slug",
      render: (value: string) => (
        <NavLink to={"/brand-detail/" + value} target="_brand">
          {"/brand-detail/" + value}
        </NavLink>
      ),
    },
              ...
              <Popconfirm
                ...
                onConfirm={async () => {
                  try {
                    ...
                    notifyUserRegistration(
                      "brand cannot be deleted at this time. Please try again",
                      NotificationType.ERROR
                    );
                  }
                }}
